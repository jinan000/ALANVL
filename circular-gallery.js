// Support both namespaced (window.ogl) and flat global injection (older UMD builds)
const _ogl = (typeof ogl !== 'undefined') ? ogl : window;
const { Renderer, Camera, Transform, Plane, Program, Mesh, Texture } = _ogl;
